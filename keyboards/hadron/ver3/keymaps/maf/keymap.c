 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   1  |   2  |   3  |   N  |   M  |   ,  |   .  |   /  | Shift|
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Lower|  `   | Ctrl | Alt  | GUI  | Bksp | DEL  | Raise|Ctl/Et| Space| GUI  | Alt  | Ctrl |  Up  | Right|
 * `--------------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT(
  KC_ESC,   KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,    KC_F9,   KC_F10, _______,\
  KC_TAB,   KC_Q,     KC_W,    KC_E,    KC_R,    KC_T,    KC_P7,   KC_P8,   KC_P9,    KC_Y,    KC_U,    KC_I,   KC_O,    KC_P, _______, \
  ...
  LOWER,    KC_GRV,   KC_LCTRL, KC_LGUI, KC_LALT, KC_BSPC, KC_DEL,  RAISE,   CTL_ENT,  KC_SPC, KC_RALT,   KC_RGUI,KC_RCTRL, KC_UP,    KC_RGHT  \
),
